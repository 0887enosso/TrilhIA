  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="rounded-3xl border-2 border-rule bg-parchment-surface p-6">
        ...
        <p className="font-variant-tabular mt-1 text-sm font-bold text-jade-strong">
          {dados.concluidos} de {dados.totalModulos} módulos concluídos
        </p>
        <div className="mt-3 h-4 w-full overflow-hidden rounded-full bg-parchment-deep shadow-well">
          <div
            className="h-full rounded-full bg-jade bg-gradient-to-b from-jade-vivid to-jade transition-[width] duration-700"
