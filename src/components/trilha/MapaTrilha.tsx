        ...
        return (
          <li key={modulo.modulo_id} className="relative">
            ...
            >
              ...
              >
                {modulo.status === "concluido" ? "✓" : modulo.ordem}
              </span>

              <span className="flex-1">
                <span className="block font-sans text-base font-extrabold text-ink">{modulo.titulo}</span>
                ...
                <span className="mt-1 block font-mono text-xs font-bold text-ink-faint">
                  {RÓTULO_STATUS[modulo.status]} · {modulo.tempo_estimado_min} min
                </span>
              </span>
